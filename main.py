...
class Launcher:
    ...
    theme = {
        ...
        "app": {
            ...
            "font": (
                ...
                15,
                "normal",
            ),  # used when no font is specified in style definition
            "font-fallback": (
                "Yu Gothic UI",
                "Nirmala UI",
                "Microsoft YaHei UI",
            ...
            "style": {
                ...
                "QTableCornerButton::section": {"background-color": "#1a1a1a"},
            },
        },
        ...
        # dark frame
        "frame": {"background-color": "@bg", "margin": 0, "padding": 0},
        # medium frame
        "medium_frame": {"background-color": "@mbg", "margin": 0, "padding": 0},
        # light frame
        "light_frame": {"background": "@lbg", "margin": 0, "padding": 0},
        ...
        "menu_button": {
            ...
            ":hover": {"text-decoration": "underline", "color": "@fg"},
            ":disabled": {"color": "@bc"},
        },
        ...
        "small_button": {
            ...
            # 'margin-right': 2,
            "padding": (2, 0, 2, 0),
            ":hover": {"background-color": "rgba(136,136,136,.2)"},
        },
        ...
        "entry": {
            ...
            ":focus": {"border-color": "@oscr"},  # cursor is inside the line
        },
        ...
        "tabber_tab": {"::tab": {"height": 0, "width": 0}},
        # used in settings
        "toggle_button": {
            "width": "100%",
            "background": "none",
        ...
        "table": {
            ...
            "::item:hover": {"background-color": "@loscr", "padding": (0, 5, 0, 5)},
            "::item:focus": {
                "background-color": "@bg",
                "color": "@fg",
            },
            ...
            # selected but not the last click of the user
            "::item:alternate:focus": {"background-color": "@mbg"},
            "::item:alternate:selected": {"background-color": "@mbg"},
        },
        ...
        "table_header": {
            ...
            "::section:hover": {"background-color": "@loscr"},
        },
        ...
        "tree_table": {
            ...
            "::branch:hover": {"background-color": "@bg", "border": "none"},
            "::branch": {"background-color": "@bg"},
            # down-pointing arrow
            "::branch:open:has-children": {"image": "url(assets/arrow-down.svg)"},
            # right-pointing arrow
            "::branch:closed:has-children": {"image": "url(assets/arrow-right.svg)"},
        },
        ...
        "tree_table_header": {
            ...
            "::section": {"background-color": "@mbg", "color": "@fg", "border": "none"},
            "::section:hover": {
                "border-width": "@bw",
                "border-style": "solid",
                "border-color": "@oscr",
    ...
    config = {
        ...
        "settings_path": r"/OSCR/.OSCR_settings.json",
        "parser1_lock": None,
        "default_settings": {
            "log_path": "",
            "dmg_columns": [True] * 16,
    ...
    def launch(self):
        c = OpenSourceCombatlogReader(
            self.version, self.theme, self.args, self.base_path, self.config
        ).run()
        sys.exit(c)
